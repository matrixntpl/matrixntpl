...
| [WMS — PostgreSQL Migration](https://github.com/matrixntpl/warehouse-management-system/tree/develop-db-postgre-migration) | PostgreSQL · Npgsql · EF Core · Neon · Render | 🔧 **In development** · Migrating WMS from SQLite to PostgreSQL for cloud deployment. Rewrote 21 EF Core migrations for PostgreSQL compatibility, completed full data migration (15 tables), and configured Neon as the managed database provider on Render |
